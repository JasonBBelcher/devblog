...
# 6. Check for values within a set range [50....100] inclusive

This one I literally just failed and it was so simple. Nerves get my heart pumping so quickly I could barely think.
Don't let this one get you. Logic is the first thing to get very hard when your entire body is in flight or flight mode.
